...
function Services() {
    ...
    const services = [
        {
            img:uxui,
            title:"UI/UX design",
            description:"Apprentissage de l'UX design sur AdobeXD et figma , savoir lire et crée du wireframe jusqu'à la maquette.",
        ...
        },
        {
            ...
            description:"Actuellement les trois langages que j'ai appris durant ma première année d'études, mais ce n'est que le début !",
        ...
        },
        {
            img:photography,
            title:"Photogénique",
            description:"C'est vrai que ce n'est pas une compétence, mais c'est toujours bon à savoir pour les photos d'entreprises.",
            bgColor:"#FF4C60",
            color:"white"
        },
    ]
    ...
    return (
        <div id="skills" className='container mt-section'>
            ...
            <p className="text-center mt-5">Vous cherchez votre prochain alternant Développeur Web ? <a href="mailto:alexandre.franck@mediaschool.me">Contactez-moi</a> 👋</p>
        </div>
    )
}
